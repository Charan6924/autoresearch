# WARNING: This file contains hardcoded paths to data.
# You will need to modify the IMAGE_ROOT, MTF_FOLDER, and PSD_FOLDER
# variables in the main() function to point to your data.
...
def main():
    ...
    for epoch in range(start_epoch, EPOCHS):
        ...
        print(f"--- Epoch {ep}/{EPOCHS}  (lr={cur_lr:.2e}) ---")
